...
public interface DatabaseInterface
{
    ...
    /**
     * Get all the seats which are reserved in all the reservations on a certain
     * flight
     *
     * @param flightID The flight to search for booked seats on.
     */
    void getAllBookedSeats(String flightID);
    
    /**
     * Finds all the booked seats on a certain reservation.
     * @param reservationID the reservation to find booked seats on.
     */
    void getBookedSeatsOnReservation(String reservationID);
}
